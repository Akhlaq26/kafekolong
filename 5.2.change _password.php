...
<nav class="navbar  navbar-fixed-top">
  ...
  <div class="bg-img" style="padding-top: 80px">
    ...
    <label for="nama"><b>Old password</b></label></br>
    <input type="password" placeholder="Enter password" name="psw" required></br>


    <label for="username"><b>New Password</b></label></br>
    <input type="password" placeholder="Enter password" name="psw" required></br>

    <label for="email"><b>Repeat Password</b></label></br>
  ...
  <form action="/action_page.php" class="container2" style="padding-top:20px">
    ...
    <button type="submit" class="btn-profile">Change email</button>
    </hr>
