...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="no.jpg" style="width: 1400px; height: 700px;">
      ...
      <div class="item">
        <img src="nn.jpg" style="width: 1400px; height: 700px;">
        <div class="carousel-caption">
          <h1 style= "font-family:  Freestyle Script; font-size: 70px">CAFE KOLONG</h1>
      ...
      <div class="item">
        <img src="nb.jpg" style="width: 1400px; height: 700px;">
        <div class="carousel-caption">
          <h1 style="font-family:  Freestyle Script; font-size: 70px">CAFE KOLONG</h1>
...
<div id="tour" class="bg-1">
  <div class="container" style="background-color: white;">
    ...
    <div class="row text-center" >
      <div class="col-sm-4" style="border-style: dotted; border-width: 2px; border-color: #b49a00;">
        <div class="thumbnail">
          <img src="nugget.jpg" style="width: 500px; height: 300px;">
          <p><strong>Nugget</strong></p>
          <p>Perpaduan antara daging ayam dan daging sapi yang diolah secara higienis</p>
          <button class="btn" style="" data-toggle="modal" data-target="#myModal">Order</button>
        </div>
      </div>
      <div class="col-sm-4" style="border-style: dotted; border-width: 2px; border-color: #b49a00;">
        <div class="thumbnail">
          <img src="jajang.jpg" style="width: 500px; height: 300px;">
      ...
      <div class="col-sm-4" style="border-style: dotted; border-width: 2px; border-color: #b49a00;">
        <div class="thumbnail">
          <img src="roti.jpg" style="width: 500px; height: 300px;"">
    ...
    <center><button type="button" class="btn " >More Menu</button></center>
  </div>
  

<!-- Container (Contact Section) -->
<div id="contact" style="background: #f1f1f1" class="container">
