...
$emaillogin =$_SESSION['email'];
        if (isset($_POST['submit'])) {
          ...
          if ($password == $row['password'] AND $oldemail == $row['email']) {
                $queryupdate ="UPDATE user SET email='$newemail' WHERE email='$oldemail'";
                mysqli_query($connection, $queryupdate);
                unset($_SESSION['email']);
                $_SESSION['email'] =  $newemail;
          echo "<meta http-equiv='refresh' content='0;url=5.1.change.php'> ";
        }
          else{
    ...
    <form method="post">
      <center><h1>Your information</h1></center>
        ...
        <div class="form-group row">
          <label for="inputEmail3" class="col-sm-3 col-form-label">Old Email</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" name="oldemail" placeholder="Enter Email" value="<?php echo $emaillogin?>">
          </div>
        </div>
        <div class="form-group row">
          <label for="inputEmail3" class="col-sm-3 col-form-label">New Email</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" name="newemail" placeholder="Enter Email">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="password" class="form-control" id="txtConfirmPassword" name="repassword" placeholder="Enter Password">
          </div>
        </div>
